  ...
  <div className="node-properties-editor">
      ...
      <div key={index} className="action-item">
       ...
       <div className="form-group">
        ...
        <textarea
         ...
         onChange={(e) => handleActionChange(index, 'functionRef.arguments', e.target.value)}
    ...
    <div className="section">
     ...
     {(formData.events || []).map((event, index) => (
      <div key={index} className="event-item">
       ...
       <div className="form-group">
        ...
        <textarea
         value={typeof event.eventRefs === 'string'
          ? event.eventRefs
     ...
     <div className="form-group">
      ...
      <input
       ...
       onChange={(e) => handleInputChange('timeouts', {
        ...formData.timeouts,
   ...
   {node.type === 'switch' && (
    <div className="section">
     ...
     <div className="section-header">
      <Settings size={16} />
      <span>{formData.conditionType === 'event' ? 'Event Conditions' : 'Data Conditions'}</span>
      <button className="add-btn" onClick={addCondition}>
       <Plus size={14} />
      </button>
     </div>

     {((formData.conditionType === 'data' ? formData.dataConditions : formData.eventConditions) || []).map((condition, index) => (
